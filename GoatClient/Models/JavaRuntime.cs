...
/// <summary>Which runtime a Minecraft version needs, from its official version JSON.</summary>
public sealed record JavaRequirement(int MajorVersion, string? Component);
